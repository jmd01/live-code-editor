...
const columns: readonly Column[] = [
  ...
  {
    id: 'attempted', label: 'Attempted', minWidth: 100, maxWidth: 100,     align: 'center'
...
const formatTime = (seconds: number) => dateFormatter.format(new Date(seconds * 1000));
              ...
              return (
                <TableRow hover role='checkbox' tabIndex={-1} key={row.id}>
                  {columns.map(column => {
                    ...
                    return (
                      <TableCell key={column.id} align={column.align}>
                        {match(column).with({id: "attempted"}, () =>
                          <CheckCircle color={value ? "success" : "disabled"}/>
                        ).with({id: "time"}, () =>
